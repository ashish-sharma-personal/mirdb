	...
	angular.module('cancerDb', [])
		...
		.controller('tabCtrl', ['$scope', '$http', function ($scope, $http) {
			...
			$scope.function = {
				...
				functionDropValues: ["Adhesion or cell cell adhesion", "Aggressiveness", "Angiogenesis", "Antioncogenic", "Apoptosis", "Autophagy", "Cell cycle arrest or cell cycle", "Cell death", "Cell spheroid formation or colony formation or sphere formation", "Chemoresistance or chemosensitivity or chemoradiotherapy", "Clonogenicity", "Cytotoxicity", "DNA damage", "Differentiation", "Epithelial Mesenchymal Transition or EMT", "Focal adhesion", "Growth or Proliferation", "Homeostasis", "Hypoxia", "Invasion", "Metastasis", "Migration or Motility", "Migration or Motility or Invasion or Metastasis", "Outgrowth or Protrusion", "Prognosis", "Progression", "Protooncogene", "Radioresistance or radiosensitivity", "Signalling or Pathway", "Survival", "Transformation", "Tumorigenesis", "Viability or cell viability", "miRNA biogenesis", "oncomiR or Tumor suppressor"],
				targetDropValues: []
			};
			$scope.snp = {
