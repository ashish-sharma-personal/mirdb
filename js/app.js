	...
	angular.module('cancerDb', [])
		...
		.controller('tabCtrl', ['$scope', '$http', function ($scope, $http) {
			...
			$scope.function = {
                ...
                functionDropValues: ["--", "Apoptosis", "Autophagy", "Cell cycle arrest", "Chemoresistance", "Chemosensitivity", "Colony Formation", "Correlation", "DNA damage", "EMT", "EMT signaling", "Growth", "Invasion", "MET", "MET ", "Metastasis", "MicroRNA replacement therapy", "Migration", "Oncogene", "Pathway", "Progression", "Proliferation", "Proliferations", "Radioresistance", "Radiosensitivity", "Signaling", "Transformation", "Tumor Suppressor", "Tumor Supressor", "Tumor suppressor", "WNt", "adenoma to carcinoma progression", "adhesion", "aggressiveness", "angiogenesis", "anoikis", "antioncogic", "apoptosis", "apoptosis  pathway", "apoptosis.", "apoptotis", "arrest", "autophagy", "cell adhesions", "cell cycle", "cell cycle Arrest", "cell cycle arrest", "cell death", "cell division", "cell invasion", "cell migration", "cell morphology", "cell motility", "cell polarization", "cell proliferation", "cell spheroid formation", "cell viability", "chemoradiotherapy", "chemoresistance", "chemosensitivity", "chemosisitivity", "clone formation", "clonogenic survival", "clonogenicity", "colony formation", "colony formation.", "correlation", "cytoskeletal remodeling", "cytoskeleton remodeling", "cytotoxicity", "cytotoxocity", "differentiation", "focal adhesion", "growth", "growth  metastasis angiogenesis", "growth arrest", "homeostasis", "hypoxia", "hypoxia ", "hypoxia signaling", "intravasation", "invasion", "invasion  metastasis", "invasion.", "invasive", "inverse", "malignancy", "malignant", "metabolism", "metastases", "metastasis", "metastasis.", "metastatic", "metastatis", "miRNA biogenesis", "migartion", "migration", "migration invasion", "mismatch", "mismatch repair", "morphology", "motility", "necrosis", "oncogene", "oncomiR", "oncomiR growth", "outgrowths", "pathway", "pathway.", "pathways", "porliferation", "prognosis", "progression", "prolifeartion", "prolifeation", "proliferation", "proliferation  apoptosis", "proliferation.", "prolliferation", "protooncogene", "protrusions", "radaiosensitivity", "radioresistance", "radiosensitivity", "repair", "replacement therapy", "self-renewal", "senescence", "sigaling", "sigaling pathway", "signalig", "signaling", "signaling pathway", "signaling pathways", "sphere formation", "stemness", "survival", "transformation", "tumor progression", "tumor suppressor", "tumorigeicity", "tumorigenecity", "tumorigenesis", "tumorigenicity", "tumorigenicity.", "tumourigenicity", "viability", "wound healing"],
			...
			$scope.searchQuery = function (formData) {
				if ($scope.tab == "2") {
					...
					$http.get('/miRNA', { params: searchData }).then(function (response) {
