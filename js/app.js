	...
	angular.module('cancerDb', [])
		...
		.controller('tabCtrl', ['$scope', '$http', function ($scope, $http) {
			...
			$scope.function = {
				...
				functionDropValues: ["Adenoma to adenocarcinoma progression", "Adenoma to carcinoma progression", "Adhesion", "Adhesions", "Aggressiveness", "Angiogenesis", "Angiogenesisin", "Anoikis", "Apoptosis", "Autophagy", "Cell cycle", "Cell cycle arrest", "Cell division", "Chemoradiotherapy", "Chemoresistance", "Chemosensitivity", "Clonogenicity", "Colony formation", "Cytoskeletal remodeling", "Cytotoxicity", "DNA repair", "Differentiation", "EMT", "Growth", "Growth Signaling", "Homeostasis", "Hypoxia", "Intravasation", "Invasion", "MET", "Malignant", "Metabolism", "Metastasis", "Metastatis", "Migration", "Migrationi", "Morphology", "Motility", "Necrosis", "OncomiR", "Outgrowth", "Pathway", "Progression", "Proliferation", "Protrusion", "Radaiosensitivity", "Radioresistance", "Radiosensitivity", "Replacement therapy", "Self renewal", "Senescence", "Signaling", "Sphere formation", "Stemness", "Supressor", "Survival", "Transformation", "Tumor", "Tumor suppressor", "Tumorigenesis", "Tumorigenicity", "Viability", "Wound healing", "apoptotis", "Colony formation", "matastasis", "polarization"],
