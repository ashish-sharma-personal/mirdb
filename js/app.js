	...
	angular.module('cancerDb', [])
		...
		.controller('tabCtrl', ['$scope', '$http', function ($scope, $http) {
			...
			$scope.expression = {
				...
				sampleDropValues: ["Blood", "Blood Tissue Stool", "Cell-line", "Cell-line Tissue", "GEO Dataset", "Gastric Juice", "Mouse Model", "N/A", "Plasma", "Plasma Tissue", "Plasma Tissue Cell-line", "Saliva Plasma", "Sample Cell-line", "Serum", "Serum Cell-line", "Serum Tissue", "Stool", "Stool Tissue", "TCGA Dataset", "TCGA Dataset,GEO Dataset,Tissue,Cell-line", "Tissue", "Tissue  Cell-line", "Tissue Blood", "Tissue Cell-line", "Tissue Cell-line Plasma", "Tissue GEO Dataset", "Tissue Plasma", "Tissue Plasma Cell-line", "Tissue Plasma Stool", "Tissue Saliva", "Tissue Serum", "Tissue Serum Cell-line", "Tissue Stool", "Tissue and Plasma", "Urine"]
			};
			$scope.function = {
